...
def process_turn(universe, orders):
    ...
    Note: both universe and orders will be modified in place
    ...
    # 10 Fleets move
    move_fleets.run(universe, orders)
    ...
    # 16. Mining
    mining.run(universe, orders)

    # 17. Production (incl. research, packepythont launch, fleet/starbase construction)
    production.run(universe, orders)

    # 18. SS Spy bonus obtained
    # 19. Population grows/dies
    pop_growth.run(universe, orders)
